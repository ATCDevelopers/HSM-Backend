...
export const prescriptionItemService = {
   ...
   */
  async createPrescriptionItem(data: typeof PrescriptionItemsTable.$inferInsert) {
   ...
   */
  async getPrescriptionItemById(id: string) {
   ...
   */
  async getItemsByPrescriptionId(prescriptionId: string) {
   ...
   */
  async updatePrescriptionItem(id: string, data: Partial<typeof PrescriptionItemsTable.$inferInsert>) {
   ...
   */
  async deletePrescriptionItem(id: string) {
    await this.getPrescriptionItemById(id);
