...
import { prescriptionsRepository, NewPrescription, Prescription } from "../repositories/perscription.respository.js";

export const prescriptionsService = {
  /**
   * Business validation for recording a new prescription row entry
   */
  async recordPrescription(data: NewPrescription): Promise<Prescription> {
   ...
   */
  async searchPrescriptionsByPatientName(name: string) {
