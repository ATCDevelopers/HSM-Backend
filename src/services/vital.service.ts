...
import { vitalsRepository, NewVitals, Vitals } from "../repositories/vitals.repository.js";

export const vitalsService = {
  /**
   * Business logic for logging a patient's vitals
   */
  async recordVitals(data: NewVitals): Promise<Vitals> {
   ...
   */
  async getVitalsById(id: string): Promise<Vitals> {
   ...
   */
  async searchVitalsByPatientName(name: string) {
   ...
   */
  async updateVitals(id: string, data: Partial<NewVitals>): Promise<Vitals> {
   ...
   */
  async getVitalsHistoryFiltered(patientId: string, timeframe: string): Promise<Vitals[]> {
    if (!patientId) {
...
///////////////////////////////////////////////////////////////////////////////////
   ...
   */
  async restoreVitals(id: string): Promise<void> {
