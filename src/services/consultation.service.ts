...
import { consultationRepository, NewConsultation } from "../repositories/consultation.repository.js";

export const consultationService = {
  /**
   * Business logic for creating a new consultation record
   */
  async recordConsultation(data: NewConsultation) {
...
/**
   ...
   */
  async getConsultationsFiltered(patientId: string, timeframe: string) {
    if (!patientId) {
   ...
   */
  async searchConsultationsByName(name: string) {
   ...
   */
  async updateConsultation(id: string, data: Partial<NewConsultation>) {
