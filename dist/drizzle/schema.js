...
export const Department = pgTable("department", {
    ...
    parentDepartmentId: uuid("parent_department_id")
        .references(() => Department.id, { onDelete: "set null" }),
    ...auditLogs
});
// 6.user_appointment
...
export const DiagnosisLabTestsTable = pgTable("diagnosis_lab_tests", {
    ...
    diagnosisId: uuid("diagnosis_id")
        .references(() => DiagnosisTable.id, { onDelete: "cascade" })
        .notNull(),
    patientId: uuid("patient_id")
        .references(() => PatientTable.id, { onDelete: "cascade" })
        .notNull(),
...
export const PrescriptionsTable = pgTable("prescriptions", {
    ...
    patientId: uuid("patient_id")
        .references(() => PatientTable.id, { onDelete: "restrict" })
        .notNull(),
    doctorId: uuid("doctor_id")
        .references(() => UserTable.id, { onDelete: "restrict" })
        .notNull(),
...
export const PatientInsurancesTable = pgTable("patient_insurances", {
    ...
    insuranceCompanyId: uuid("insurance_company_id")
        .references(() => InsuranceCompaniesTable.id, { onDelete: "restrict" })
        .notNull(),
...
export const BedsTable = pgTable("beds", {
    ...
    wardId: uuid("ward_id")
        .references(() => WardsTable.id, { onDelete: "cascade" })
        .notNull(),
    ...
    roomId: uuid("room_id")
        .references(() => RoomsTable.id, { onDelete: "set null" }),
    ...auditLogs, // Automatically injects your 6 core audit columns
});
// 29 . Rooms
