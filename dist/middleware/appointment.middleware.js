...
export const validateDoctorScheduleInput = (req, res, next) => {
...
export const validateBookAppointmentInput = (req, res, next) => {
...
export const validateRescheduleInput = (req, res, next) => {
...
export const validateCancelInput = (req, res, next) => {
...
export const validateStatusInput = (req, res, next) => {
