...
import { createInvoiceItem, getAllInvoiceItems, getInvoiceItemById, getItemsByInvoiceId, updateInvoiceItem, deleteInvoiceItem } from "../controllers/invoiceItem.controller.js"; // Direct independent named imports
const router = Router();
